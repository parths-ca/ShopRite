...
if(isset($_GET["eid"]) && !empty($_GET["eid"])){
        $eid = $_GET["eid"];
        $result = mysqli_query($con, "Select * from product_branch where Product_branch_id='{$eid}'")or die(mysqli_error($con));
...
if($_POST){
    ...
    $result = mysqli_query($con, "UPDATE `product_branch` SET `Branch_id`='{$txtBranchId}',`Product_id`='{$txtProductId}' WHERE Product_branch_id='{$eid}' ")or die(mysqli_error($con));
    if($result){
        header("location:view-product-branch.php");
    }
}
                ...
                <div class="container">
                    ...
                    <div class="row heading-bg">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h5 class="txt-dark">Products Branch</h5>
                        </div>
