...
if($_POST){
    ...
    $result = mysqli_query($con, "INSERT INTO `admin`(`Admin_name`, `Admin_email`, `Admin_password`, `Contact_no`) VALUES ('{$txtAdminName}','{$txtAdminEmail}','{$txtAdminPassword}','{$txtAdminContact}')")or die(mysqli_error($con));
    if($result){
                                                ...
                                                <div class="form-wrap">
                                                    <form data-toggle="validator" method="POST" role="form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input  type="text" class="form-control" id="inputName" name="txtAdminName" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputName" class="control-label mb-10">Email</label>
                                                            <input type="text" class="form-control" id="inputName" name="txtAdminEmail" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputName" class="control-label mb-10">Password</label>
                                                            <input type="password" class="form-control" id="inputName" name="txtAdminPassword" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputName" class="control-label mb-10">Contact</label>
                                                            <input type="number" class="form-control" id="inputName" name="txtAdminContact" required>
                                                        </div>
