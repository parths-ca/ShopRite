...
if($_POST){
    ...
    $result = mysqli_query($con, "INSERT INTO `area`(`Area_name`) VALUES ('{$txtAreaName}')")or die(mysqli_error($con));
    if($result){
                                                ...
                                                <div class="form-wrap">
                                                    <form data-toggle="validator" method="POST" role="form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="inputName" name="txtAreaName" required>
                                                        </div>
