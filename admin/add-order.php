...
if($_POST){
    ...
    $result = mysqli_query($con, "INSERT INTO `order`(`Order_date`, `Customer_id`, `Branch_id`, `Employee_id`, `Order_status`) VALUES ('{$txtOrderDate}','{$txtCustomerId}','{$txtBranchId}','{$txtEmployeeId}','{$txtOrderStatus}')") or die(mysqli_error($con));
    if($result){
                                                ...
                                                <div class="form-wrap">
                                                    <form data-toggle="validator" method="POST" role="form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" id="inputName" name="txtOrderDate" required>
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label for="inputName" class="control-label mb-10">Order Status</label>
                                                            <input type="text" class="form-control" id="inputName" name="txtOrderStatus" required>
                                                        </div>
                                                        <div class="form-group">
