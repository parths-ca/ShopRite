...
if (isset($_GET["did"])) {
    $did = $_GET["did"];
    $result = mysqli_query($con, "Delete from customer where Customer_id='{$did}'")or die(mysqli_error($con));
    if ($result) {
    ...
    INNER JOIN `customer` 
        ON (`branch`.`Branch_id` = `customer`.`Branch_id`);")or die(mysqli_error($con));
                                                            while ($row = mysqli_fetch_assoc($result)){
                                                                ...
                                                                echo "<td><a href='edit-customer.php?eid={$row["Customer_id"]}'>Edit</a> | <a href='?did={$row["Customer_id"]}'>Delete</a></td>";
                                                                echo "</tr>";
                                                            }
